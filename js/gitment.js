...
function createObservable(v) {
    ...
    invariant(arguments.length <= 1, getmessage("m021")); invariant(!ismodifierdescriptor(v), getmessage("m020")); if (isobservable(v)) { return v; } var res="deepEnhancer(v);;" ;console.log(res); iobservablefactories="function" () function iobservablefactories() {} iobservablefactories.prototype.box="function" (value, name) (arguments.length> 2) incorrectlyUsedAsDecorator("box");
